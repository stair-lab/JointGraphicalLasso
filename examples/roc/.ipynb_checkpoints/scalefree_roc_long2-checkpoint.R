...
for(q in 1:replic_num){
    ...
    if(q %% 10 == 0){
        ...
        save(fgl_roc, file=paste("../../results/FGL",replic_num,"_scalefree_long2.RData",sep=""))
    }
}
}
...
for(q in 1:replic_num){
    ...
    if(q %% 10 == 0){
        ...
        save(ggl_roc, file=paste("../../results/GGL",replic_num,"_scalefree_long2.RData",sep=""))
    }
}
}
...
for(q in 1:replic_num){
    ...
    if(q %% 10 == 0){
        ...
        save(gl_roc, file=paste("../../results/GL",replic_num,"_scalefree_long2.RData",sep=""))
    }
}
}
