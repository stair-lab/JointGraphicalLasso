...
load("../../results/new_roc/roc_1/FGL20_dgp1.RData")
print("Loading FGL20_dgp1.RData...")
print(paste("Replications:", length(fgl_roc[[1]]$FPR),"lam1:",dim(fgl_roc[[1]]$FPR[[1]])[1],
            "lam2:",dim(fgl_roc[[1]]$FPR[[1]])[2]))

load("../../results/new_roc/roc_1/GGL20_dgp1.RData")
print("Loading GGL20_dgp1.RData...")
print(paste("Replications:", length(ggl_roc[[1]]$FPR),"lam1:",dim(ggl_roc[[1]]$FPR[[1]])[1],
            "lam2:",dim(ggl_roc[[1]]$FPR[[1]])[2]))

load("../../results/new_roc/roc_1/GL20_dgp1.RData")
print("Loading GL20_dgp1.RData")
...
png("../../figures/FGL_dgp1.png",width = 480, height = 480, units = "px", pointsize = 12)
...
png("../../figures/GGL_dgp1.png",width = 480, height = 480, units = "px", pointsize = 12)
plot(NULL,xlab="FPR", ylab="TPR",xlim = c(0.,1.),ylim = c(0.,1.),type = "n")
...
png(file=paste("../../figures/dgp1_roc.png",sep=""))
